...
> 当前状态：**v0（M0–M4）+ v1 三阶段全部完成并验收** —— 36+80+157+39+48+43+42 = **445 项断言**全部离线可复现：
...
.venv/bin/python -m scripts.m1_check   # M1 阶段 A（80 项）
.venv/bin/python -m scripts.m2_check   # M2 阶段 B（157 项）
...
backend/scripts/m2_check.py        M2 验收脚本（157 项断言）
